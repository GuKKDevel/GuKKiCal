...
class GuKKiCalcDaylight extends GuKKiCalComponent {
	...
	protected GuKKiCalcDaylight(String cDaylightDaten) throws Exception {
		if (logger.isLoggable(logLevel)) {
			logger.log(logLevel, "begonnen");
		}
		
		this.kennung = GuKKiCalcKennung.DAYLIGHT;

		einlesenAusDatenstrom(cDaylightDaten);
...
// Anfang der generierten Methoden für GuKKiCalcDaylight 0.1 Wed Dec 08 23:39:38 CET 2021
...
// Ende der generierten Methoden für GuKKiCalcDaylight
// @formatter:on    	 	
}
